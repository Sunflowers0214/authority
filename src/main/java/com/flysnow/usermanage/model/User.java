...
public class User {
	...
	private String firstLoginType;//第一次登录类型
	private Date firstLoginTime;//第一次登录时间
	private String lastLoginType;//最后一次登录类型
	...
	public String  getFirstLoginType(){
		return firstLoginType;
	}
	public void  setFirstLoginType(String firstLoginType){
	...
	public String toString() {
		...
		sb.append("firstLoginType="+firstLoginType+",");
		sb.append("firstLoginTime="+firstLoginTime+",");
		sb.append("lastLoginType="+lastLoginType+",");
